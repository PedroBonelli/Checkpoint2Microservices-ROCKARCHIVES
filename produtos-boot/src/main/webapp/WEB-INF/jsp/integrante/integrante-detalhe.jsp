        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="well bg-novo">
					...
					<h2 class="title-font mb-3">Integrante - Editar</h2>
					
						<div class="form-group">
							<label class="control-label text-font" for="nome">Nome:</label>
							<b class="text-font">${integrante.nome}</b>
                        </div>
					
						
						<div class="form-group">
							<label class="control-label text-font" for="nome">Função:</label>
							<b class="text-font">${integrante.role}</b>
                        </div>
					
						
						<div class="form-group">
							<label class="control-label text-font" for="nome">Gênero:</label>
							<b class="text-font">${integrante.genero}</b>
                        </div>
					
						
						<div class="form-group">
							<label class="control-label text-font" for="nome">Banda:</label>
							<b class="text-font">${integrante.banda.nome}</b>
                        </div>	
						
						<a class="btn btn-purple btn-lg" href="${contextPath}/integrantes">Voltar</a>
